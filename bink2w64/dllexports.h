...
#pragma comment(linker, "/export:CreateDirect3D11DeviceFromDXGIDevice=hkdl.CreateDirect3D11DeviceFromDXGIDevice")
#pragma comment(linker, "/export:CreateDirect3D11SurfaceFromDXGISurface=hkdl.CreateDirect3D11SurfaceFromDXGISurface")
#pragma comment(linker, "/export:D3D11CoreCreateDevice=hkdl.D3D11CoreCreateDevice")
#pragma comment(linker, "/export:D3D11CoreCreateLayeredDevice=hkdl.D3D11CoreCreateLayeredDevice")
#pragma comment(linker, "/export:D3D11CoreGetLayeredDeviceSize=hkdl.D3D11CoreGetLayeredDeviceSize")
#pragma comment(linker, "/export:D3D11CoreRegisterLayers=hkdl.D3D11CoreRegisterLayers")
#pragma comment(linker, "/export:D3D11CreateDevice=hkdl.D3D11CreateDevice")
#pragma comment(linker, "/export:D3D11CreateDeviceAndSwapChain=hkdl.D3D11CreateDeviceAndSwapChain")
#pragma comment(linker, "/export:D3D11CreateDeviceForD3D12=hkdl.D3D11CreateDeviceForD3D12")
#pragma comment(linker, "/export:D3D11On12CreateDevice=hkdl.D3D11On12CreateDevice")
#pragma comment(linker, "/export:D3DKMTCloseAdapter=hkdl.D3DKMTCloseAdapter")
#pragma comment(linker, "/export:D3DKMTCreateAllocation=hkdl.D3DKMTCreateAllocation")
#pragma comment(linker, "/export:D3DKMTCreateContext=hkdl.D3DKMTCreateContext")
#pragma comment(linker, "/export:D3DKMTCreateDevice=hkdl.D3DKMTCreateDevice")
#pragma comment(linker, "/export:D3DKMTCreateSynchronizationObject=hkdl.D3DKMTCreateSynchronizationObject")
#pragma comment(linker, "/export:D3DKMTDestroyAllocation=hkdl.D3DKMTDestroyAllocation")
#pragma comment(linker, "/export:D3DKMTDestroyContext=hkdl.D3DKMTDestroyContext")
#pragma comment(linker, "/export:D3DKMTDestroyDevice=hkdl.D3DKMTDestroyDevice")
#pragma comment(linker, "/export:D3DKMTDestroySynchronizationObject=hkdl.D3DKMTDestroySynchronizationObject")
#pragma comment(linker, "/export:D3DKMTEscape=hkdl.D3DKMTEscape")
#pragma comment(linker, "/export:D3DKMTGetContextSchedulingPriority=hkdl.D3DKMTGetContextSchedulingPriority")
#pragma comment(linker, "/export:D3DKMTGetDeviceState=hkdl.D3DKMTGetDeviceState")
#pragma comment(linker, "/export:D3DKMTGetDisplayModeList=hkdl.D3DKMTGetDisplayModeList")
#pragma comment(linker, "/export:D3DKMTGetMultisampleMethodList=hkdl.D3DKMTGetMultisampleMethodList")
#pragma comment(linker, "/export:D3DKMTGetRuntimeData=hkdl.D3DKMTGetRuntimeData")
#pragma comment(linker, "/export:D3DKMTGetSharedPrimaryHandle=hkdl.D3DKMTGetSharedPrimaryHandle")
#pragma comment(linker, "/export:D3DKMTLock=hkdl.D3DKMTLock")
#pragma comment(linker, "/export:D3DKMTOpenAdapterFromHdc=hkdl.D3DKMTOpenAdapterFromHdc")
#pragma comment(linker, "/export:D3DKMTOpenResource=hkdl.D3DKMTOpenResource")
#pragma comment(linker, "/export:D3DKMTPresent=hkdl.D3DKMTPresent")
#pragma comment(linker, "/export:D3DKMTQueryAdapterInfo=hkdl.D3DKMTQueryAdapterInfo")
#pragma comment(linker, "/export:D3DKMTQueryAllocationResidency=hkdl.D3DKMTQueryAllocationResidency")
#pragma comment(linker, "/export:D3DKMTQueryResourceInfo=hkdl.D3DKMTQueryResourceInfo")
#pragma comment(linker, "/export:D3DKMTRender=hkdl.D3DKMTRender")
#pragma comment(linker, "/export:D3DKMTSetAllocationPriority=hkdl.D3DKMTSetAllocationPriority")
#pragma comment(linker, "/export:D3DKMTSetContextSchedulingPriority=hkdl.D3DKMTSetContextSchedulingPriority")
#pragma comment(linker, "/export:D3DKMTSetDisplayMode=hkdl.D3DKMTSetDisplayMode")
#pragma comment(linker, "/export:D3DKMTSetDisplayPrivateDriverFormat=hkdl.D3DKMTSetDisplayPrivateDriverFormat")
#pragma comment(linker, "/export:D3DKMTSetGammaRamp=hkdl.D3DKMTSetGammaRamp")
#pragma comment(linker, "/export:D3DKMTSetVidPnSourceOwner=hkdl.D3DKMTSetVidPnSourceOwner")
#pragma comment(linker, "/export:D3DKMTSignalSynchronizationObject=hkdl.D3DKMTSignalSynchronizationObject")
#pragma comment(linker, "/export:D3DKMTUnlock=hkdl.D3DKMTUnlock")
#pragma comment(linker, "/export:D3DKMTWaitForSynchronizationObject=hkdl.D3DKMTWaitForSynchronizationObject")
#pragma comment(linker, "/export:D3DKMTWaitForVerticalBlankEvent=hkdl.D3DKMTWaitForVerticalBlankEvent")
#pragma comment(linker, "/export:D3DPerformance_BeginEvent=hkdl.D3DPerformance_BeginEvent")
#pragma comment(linker, "/export:D3DPerformance_EndEvent=hkdl.D3DPerformance_EndEvent")
#pragma comment(linker, "/export:D3DPerformance_GetStatus=hkdl.D3DPerformance_GetStatus")
#pragma comment(linker, "/export:D3DPerformance_SetMarker=hkdl.D3DPerformance_SetMarker")
#pragma comment(linker, "/export:EnableFeatureLevelUpgrade=hkdl.EnableFeatureLevelUpgrade")
#pragma comment(linker, "/export:OpenAdapter10=hkdl.OpenAdapter10")
#pragma comment(linker, "/export:OpenAdapter10_2=hkdl.OpenAdapter10_2")

/*#pragma comment(linker, "/export:DirectSoundCaptureCreate=hkdl.DirectSoundCaptureCreate")
#pragma comment(linker, "/export:DirectSoundCaptureCreate8=hkdl.DirectSoundCaptureCreate8")
#pragma comment(linker, "/export:DirectSoundCaptureEnumerateA=hkdl.DirectSoundCaptureEnumerateA")
#pragma comment(linker, "/export:DirectSoundCaptureEnumerateW=hkdl.DirectSoundCaptureEnumerateW")
#pragma comment(linker, "/export:DirectSoundCreate=hkdl.DirectSoundCreate")
#pragma comment(linker, "/export:DirectSoundCreate8=hkdl.DirectSoundCreate8")
#pragma comment(linker, "/export:DirectSoundEnumerateA=hkdl.DirectSoundEnumerateA")
#pragma comment(linker, "/export:DirectSoundEnumerateW=hkdl.DirectSoundEnumerateW")
#pragma comment(linker, "/export:DirectSoundFullDuplexCreate=hkdl.DirectSoundFullDuplexCreate")
#pragma comment(linker, "/export:DllCanUnloadNow=hkdl.DllCanUnloadNow")
#pragma comment(linker, "/export:DllGetClassObject=hkdl.DllGetClassObject")
#pragma comment(linker, "/export:GetDeviceID=hkdl.GetDeviceID")*/
